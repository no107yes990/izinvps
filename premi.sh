...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/no107yes990/izinvps/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/no107yes990/izinvps/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/no107yes990/izinvps/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
restart_system(){
USRSC=$(curl -sS https://raw.githubusercontent.com/no107yes990/izinvps/main/ip | grep $MYIP | awk '{print $2}')
EXPSC=$(curl -sS https://raw.githubusercontent.com/no107yes990/izinvps/main/ip | grep $MYIP | awk '{print $3}')
